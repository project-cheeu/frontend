...
import { PresurveyContent } from './components';
import { ArrowLeftOutlined, ArrowRightOutlined } from '@ant-design/icons';
import './Presurvey.css';

const PresurveyPresenter = ({ surveyList, setSurveyAnswer, insertAnswer }) => {
  ...
  const handeSurveyAnswer = (reply, text = false) => {
...
export default PresurveyPresenter;
