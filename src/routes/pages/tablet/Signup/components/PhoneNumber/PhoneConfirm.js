...
const PhoneConfirm = ({
    ...
    <div className="phoneconfirm-container">
      ...
      <div className="btn-container">
        ...
        <Button
          ...
          className="phoneconfirm-btn"
          onClick={() => {
            if (dump && dumps.length >= 1) {
              signupOldAction(dumps);
            } else {
              signupAction();
            }
          }}
  ...
  //   userInfo.length === 1 ? (
  //     <div className="phoneconfirm-container">
  //       <div>{userInfo[0].customer_nm} 님이 맞으신가요?</div>
  //       <Descriptions bordered className="userinfo-container">
  //         <Descriptions.Item label="고객명" span={3} className="userinfo">
  //           {userInfo[0].customer_nm}
  //         </Descriptions.Item>
  //         <Descriptions.Item label="생년월일" span={3} className="userinfo">
  //           {rrn(userInfo[0].customer_num)}
  //         </Descriptions.Item>
  //         <Descriptions.Item label="전화번호" span={3} className="userinfo">
  //           {userInfo[0].customer_tel}
  //         </Descriptions.Item>
  //       </Descriptions>
  //       <div className="btn-container">
  //         <Button
  ...
  // ) : (
  //   <div className="phoneconfirm-container">
  //     <div>병원에 등록된 정보가 없습니다.</div>
  //     <div>신규 접수 화면으로 이동하시겠습니까?</div>
  //     <div className="btn-container">
  //       <Button
  //         type="default"
  //         className="phoneconfirm-btn"
